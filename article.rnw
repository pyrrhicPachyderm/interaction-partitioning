...
However, weak interactions have been shown to be very important to the stability of ecological communities \parencite{wootton2016many}, and setting these to zero may lose important information.
...
We fit the Lotka--Volterra model to find the groupings that give the most parsimonious model.
...
\begin{figure}
	...
	\caption{%
		A histogram of the {\ic} values of species interaction models with all possible groupings of interaction coefficients.
...
This result stands in contrast to the popular wisdom in ecology that species should form some sort of clear groups, be they the functional groups so often used \parencite{blondel2003guilds}, or taxonomic groups per a relationship between phylogeny and ecological niche \parencite{godoy2014phylogenetic}.
