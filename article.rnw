...
\begin{figure}
	...
	<<>>=
		...
		abline(v = brute_data$fully_grouped_statistics[[ic]], lwd=2, lty="dotted", col="purple")
	@
	\end{subfigure}
...
\begin{figure}
	...
	\begin{subfigure}{0.49\textwidth}
		\centering
		<<>>=
			cat(minimal_coclassification_kable(
...
\begin{figure}
	...
	\begin{subfigure}{\textwidth}
		\centering
		<<>>=
			cat(weighted_coclassification_kable(
