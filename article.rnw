...
To the best of our knowledge, all studies that use grouping to simplify models of species interactions have also made one additional, untested assumption: that the same grouping is equally valid for how species affect others as for how species respond to others \parencite{XXX}.
